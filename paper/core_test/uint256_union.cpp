...
{
	paper::uint256_union bytes1 ("FEDCBA9876543210FEDCBA9876543210FEDCBA9876543210FEDCBA9876543210");
	...
	ASSERT_EQ (paper::uint256_t ("0xFEDCBA9876543210FEDCBA9876543210FEDCBA9876543210FEDCBA9876543210"), bytes1.number ());
...
{
    paper::uint256_union value;
    ASSERT_FALSE (value.decode_base58check (paper::test_genesis_key.pub.to_base58check ()));
